...
map.getView().fit([8521837.126412, 514403.317223, 9617341.111551, 1216392.933271], map.getSize());
    ...
    element: (() => {
        ...
        if (60 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'this map shows the main road ways and waterways in sri lanka';
            }
